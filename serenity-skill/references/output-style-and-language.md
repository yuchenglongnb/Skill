...
4. For single-company answers, place the company in a relative map of competitors, substitutes, customers, suppliers, and useful analogues.
5. Explain evidence and uncertainty.
6. Mention popular areas that ranked lower and why.
7. Say what could make the view wrong.
8. Give the next checks.
...
For single-company research, add a compact relative-position block when it improves the answer:

`exact layer / direct competitors / adjacent substitutes / customer chain / supplier chain / cross-industry analogue / where the analogy breaks`

Use analogies carefully. They should clarify economics, not replace evidence. A loose "this is the ASML of X" style claim is not enough; explain both the useful comparison and the broken parts.
