...
def export_corpus_bundle(
    ...
    *,
    ...
    report_paths = [
        ...
        reports_dir / "comment_state_warnings.md",
    ...
    reconcile_comment_article_states(raw_dir, max_pages_limit=max_pages_limit)
    ...
    build_comment_state_warning_report(raw_dir, reports_dir)
    build_comment_coverage_report(raw_dir, report_paths[3])
    build_author_inventory(raw_dir, report_paths[4], target_config)
    build_image_inventory(raw_dir, report_paths[5])
    build_filter_quality_report(raw_dir, report_paths[6])
