...
from tgb_pipeline.models import ArticleIndex, Comment, ImageAsset, Interaction
    ...
    *,
    ...
    for article in index_store.read_all():
        ...
        while next_page_num <= max_pages and (
            ...
            _save_snapshot(html_root / f"{article.article_id}_comments_page_{next_page_num}.html", html)
